    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
          ...
          String field8=request.getParameter("t8");
            ...
            String field12=request.getParameter("t12");
            String field13=request.getParameter("t13");           
            int field14=0;
            ...
            try
            {
                ...
                PreparedStatement pst=con.prepareStatement("insert into registrationforcandidate values(?,?,?,?,?,?,?,?,?,?,?,?,?)");
                if(field11.equals(field13))
                {
                ...
                pst.setString(11,field11);
                 pst.setString(12,field12);
                  pst.setInt(13,field14);
